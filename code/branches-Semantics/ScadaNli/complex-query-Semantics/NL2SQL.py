...
config_path='D:\\吴昊\\SCADANLI2020\\CodeSCADANLI\\nl2sqlbaseline\\model\\chinese_wwm_ext_L-12_H-768_A-12\\bert_config.json'
checkpoint_path = 'D:\\吴昊\\SCADANLI2020\\CodeSCADANLI\\nl2sqlbaseline\\model\\chinese_wwm_ext_L-12_H-768_A-12\\bert_model.ckpt'
dict_path = 'D:\\吴昊\\SCADANLI2020\\CodeSCADANLI\\nl2sqlbaseline\\model\\chinese_wwm_ext_L-12_H-768_A-12\\vocab.txt'
...
train_data, train_tables = read_data('D:/吴昊/SCADANLI2020/CodeSCADANLI/nl2sqlbaseline/data/train/train.json','D:/吴昊/SCADANLI2020/CodeSCADANLI/nl2sqlbaseline/data/train/train.tables.json')
valid_data, valid_tables = read_data('D:/吴昊/SCADANLI2020/CodeSCADANLI/nl2sqlbaseline/data/val/val.json','D:/吴昊/SCADANLI2020/CodeSCADANLI/nl2sqlbaseline/data/val/val.tables.json')
test_data, test_tables = read_data('D:/吴昊/SCADANLI2020/CodeSCADANLI/nl2sqlbaseline/data/test/test.json','D:/吴昊/SCADANLI2020/CodeSCADANLI/nl2sqlbaseline/data/test/test.tables.json')
...
def most_similar(s, slist):
    ...
    if len(slist) == 0:
        return s
    scores = [editdistance.eval(s, t) for t in slist]#注意：这里是距离越大越不相同，而余弦相似度是越大越相似·
...
class data_generator:
    def __init__(self, data, tables, batch_size=128):
        self.data = data
        self.tables = tables
    ...
    def __iter__(self):
        while True:
            idxs = list(range(len(self.data)))#range产生一个list，可以用来迭代
            ...
            for i in idxs:
                ...
                for j in d['sql']['conds']:
                    ...
                    if j[2] not in d['question']:
                        continue
                    k = d['question'].index(j[2])#index方法是为了返回查找对象的索引位置
